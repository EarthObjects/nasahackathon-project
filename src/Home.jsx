...
function Home({ isListVisible, currentList }) {
  ...
  return (
    <Container style={{ backgroundColor: theme.palette.background.default, minHeight: '100vh' }}>
          ...
          >
            <Box
              style={{
                ...
                alignItems: 'center',
                height: '80vh', // Ensure the container has a defined height
                overflow: 'hidden',
              }}
            >
              <SpaceObjects theme={theme} />
            </Box>
          </Animate>
        </Grid>
      </Grid>
      <Box component="section" sx={{ p: 8, backgroundColor: theme.palette.background.default }}></Box>
